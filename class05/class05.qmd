...
There are many graphics systems in R for making plots and figures. These include so-called *"base R" graphics* like this `plot()` function and add on packages like **ggplot2**.
...
> Q. Can you make the `geom_smooth() function produce a linear straight line fir to the data and turn off the "gray" error region.
